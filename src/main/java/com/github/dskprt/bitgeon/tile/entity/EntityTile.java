...
public class EntityTile extends Tile {
    ...
    public EntityTile(TileMap parent, String id, Vector2f coordinates, boolean canInteract, boolean canCollide, byte data) {
        this(parent, id, coordinates, new Rectangle2D.Float(0, 0, TILE_WIDTH, TILE_HEIGHT), null, canInteract, canCollide, data);
    }

    public EntityTile(TileMap parent, String id, Vector2f coordinates, Rectangle2D.Float collisionBox, boolean canInteract, boolean canCollide, byte data) {
        this(parent, id, coordinates, collisionBox, null, canInteract, canCollide, data);
    }

    public EntityTile(TileMap parent, String id, Vector2f coordinates, Inventory inventory, boolean canInteract, boolean canCollide, byte data) {
        this(parent, id, coordinates, new Rectangle2D.Float(0, 0, TILE_WIDTH, TILE_HEIGHT), inventory, canInteract, canCollide, data);
    }

    public EntityTile(TileMap parent, String id, Vector2f coordinates, Rectangle2D.Float collisionBox, Inventory inventory, boolean canInteract, boolean canCollide, byte data) {
        this(parent, id, coordinates, collisionBox, inventory, 10f, canInteract, canCollide, data);
    }

    public EntityTile(TileMap parent, String id, Vector2f coordinates, Rectangle2D.Float collisionBox, Inventory inventory, float health, boolean canInteract, boolean canCollide, byte data) {
        super(parent, id, CachedImageIO.read(BlockTile.class.getResource("/textures/entities/" + id + ".png")), coordinates, collisionBox, canCollide);
